...
- **Install Minikube**
  ...
  - Open browser and search: `Install Minikube` -> https://minikube.sigs.k8s.io/docs/start/?arch=%2Flinux%2Fx86-64%2Fstable%2Fbinary+download
...
- **Install kubectl**
  ...
  - Run the first command with `curl` from the official Kubernetes docs  -> https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/
